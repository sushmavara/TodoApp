...
eval("function showContent(evt, id) {\n  var i, menuItems, navLinks;\n  menuItems = document.getElementsByClassName(\"menu-item\");\n\n  for (i = 0; i < menuItems.length; i++) {\n    menuItems[i].style.display = \"none\";\n  }\n\n  navLinks = document.getElementsByClassName(\"nav-links\");\n\n  for (i = 0; i < navLinks.length; i++) {\n    navLinks[i].classList.remove(\"active\");\n  }\n\n  document.getElementById(id).style.display = \"block\";\n  evt.currentTarget.classList.add('active');\n}\n\ndocument.querySelector('.to-do-app-nav').addEventListener('click', function (event) {\n  showContent(event, 'to-do-app');\n});\ndocument.querySelector('.calendar-app-nav').addEventListener('click', function (event) {\n  showContent(event, 'calendar-app');\n});\nvar a = 12;\nconsole.log(a); // To Display Data Modals   \n\nfunction initializeModal(modalID, buttonID) {\n  var modal = document.getElementById(modalID);\n  var btn = document.getElementById(buttonID);\n  var span = modal.querySelector('.close-button');\n  var cancelBtn = modal.querySelector('.cancel'); // toggle show modal class\n\n  function toggleModal() {\n    modal.classList.toggle(\"show-modal\");\n  } // When the user clicks on the button, open the modal\n\n\n  btn.addEventListener('click', toggleModal); // When the user clicks on <span> (x), close the modal\n\n  span.addEventListener('click', toggleModal); // When user clicks on cancel/discard button close it\n\n  cancelBtn.addEventListener('click', toggleModal); // When the user clicks anywhere outside of the modal, close it\n\n  window.addEventListener('click', function (event) {\n    if (event.target == modal) {\n      modal.classList.toggle(\"show-modal\");\n    }\n  });\n}\n\nwindow.addEventListener('load', function () {\n  initializeModal('add-item-modal', 'add-new-todo');\n  initializeModal('delete-confirmation-modal', 'delete');\n});\n\n//# sourceURL=webpack:///./src/js/index.js?");
