...
'<h3> Add New Todo Item</h3></div><div class="modal-body"><div><label for="title"> Title : </label><br><input type="text" name="title" class="todo-title input-element"><span class="error-message">Title can not be empty</span>'+
...
export const updateTodoModalTemplate = '<div id="update-item-modal" class="modal" data-target="%target-id%"><div class="modal-content"><div class="modal-header"><i class="icon ion-md-close close-button"></i>'+
'<h3> Update Todo Item</h3></div><div class="modal-body"><div><label for="title"> Title : </label><br><input type="text" name="title" class="todo-title input-element"><span class="error-message">Title can not be empty</span>'+
