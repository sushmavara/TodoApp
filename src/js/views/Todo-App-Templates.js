...
'<h3> Add New Todo Item</h3></div><div class="modal-body"><div><label for="title"> Title : </label><br><input type="text" name="title" class="todo-title input-element"><p class="error-message">Title can not be empty</p>'+
